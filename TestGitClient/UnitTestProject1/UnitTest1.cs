...
namespace UnitTestProject1
{
    ...
    {
        public SyntakTreeDecorator SyntaxTreeFromString(string source)
        {
            return TreeHelper.SyntaxTreeFromString(source,null,null,null);
        }
        ...
        {
            var from = SyntaxTreeFromString(" namespace test{  public class Foo1{}}");
            var to = SyntaxTreeFromString(" namespace test{  public class Foo1{}}");
        ...
        {
            var from = SyntaxTreeFromString(" namespace test{  public class Foo1{}}");
            var to = SyntaxTreeFromString(" namespace test{  public class Foo2{}}");
        ...
        {
            var from = SyntaxTreeFromString(" namespace test{  public class Foo1{}}");
            var to = SyntaxTreeFromString(" namespace test2{  public class Foo1{}}");
            ...
            Assert.IsTrue(foo.howModified.HasFlag(ModificationKind.contentChanged));
            Assert.IsTrue(foo.howModified.HasFlag(ModificationKind.nameChanged));
